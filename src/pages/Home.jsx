...
const Home = () => {
  return (
    <main className='min-h-screen py-8 w-full'>
      ...
      <div className='flex flex-row justify-between items-center w-[1240px] mx-auto pt-24 gap-5'>
      ...
      <div className='flex flex-row bg-[#E6EAF5] w-[1240px] h-[451px] justify-self-center justify-between mx-auto mt-10 px-36'>
      <div className='flex flex-col justify-center items-start gap-4'>
